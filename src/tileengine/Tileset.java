...
public class Tileset {
    public static final TETile AVATAR = new TETile('a', Color.white, Color.black, "you", "tileengine/duck.png", 0);
    public static final TETile WALL = new TETile('#', new Color(216, 128, 128), Color.darkGray,
            "wall", 1);
    public static final TETile FLOOR = new TETile('·', new Color(128, 192, 128), Color.black, "floor", 2);
    public static final TETile TORCH = new TETile('•', Color.WHITE, new Color(149, 51, 240), "torch", 2);
    ...
    public static final TETile WATER = new TETile('≈', new Color(36, 143, 177), new Color(43, 62, 156), "water", 5);
